...
BOOL ProcessInfo::ProcessLog()
{
	...
	sprintf_s(FileName, "E://ProcMon//MarvellousLog %02d_%02d_%02d%s.txt", lt.wHour, lt.wMinute, lt.wDay, month[lt.wMonth - 1]);
...
BOOL ProcessInfo::ReadLog(DWORD hr, DWORD min, DWORD date, DWORD month)
{
	...
	sprintf_s(FileName, "E://ProcMon//Marvellous Log%2d_%2d_%2d %s.txt", hr, min, date, montharr[month - 1]);
